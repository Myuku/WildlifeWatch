...
export default function Footer() {
  ...
  return (
    <footer className="footer-container flex flex-row justify-between m-8">
      ...
      <div className="footer-left">
        ...
        <div className="social-icons">
          ...
          <button onClick={handleYouTubeClick} aria-label="YouTube">
            <Image
              src="/youtube-you-tube-video-svgrepo-com.svg"
              alt="YouTube"
              width={20}
              height={20}
            />
      ...
      <div className="footer-right">
        <div className="footer-topic justify-center">
          Contact Us!<div>101-101-1001</div>
        </div>
      </div>
    </footer>
  );
